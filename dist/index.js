...
import require$$3, { createHmac, pbkdf2Sync, randomBytes as randomBytes$2, createHash } from 'crypto';
...
class ChainManager {
    ...
    syncNonce() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.nonce === null) {
                ...
                this.nonce = yield this.nonceSyncing;
            }
        });
    }
    /**
    ...
    signTransaction(tx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const transaction = Object.assign(Object.assign({}, tx), { nonce });
            // Increment nonce for the next transaction
            this.incrementNonce();
            // Sign the transaction
            const signedTx = yield this.wallet.signTransaction(transaction);
            return signedTx;
        });
    }
    /**
    ...
    validateFunds(tx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tx.gasLimit === undefined) {
                ...
                gasEstimate = yield this.provider.estimateGas(Object.assign(Object.assign({}, tx), { gasLimit: this.balance }));
            }
            else {
                console.log("using given gaslimit for estimation:", tx.gasLimit);
                gasEstimate = yield this.provider.estimateGas(tx);
            }
            const gasPrice = (yield this.provider.getFeeData()).gasPrice;
            if (gasPrice === null) {
    ...
    sendTransaction(tx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.validateFunds(tx);
            // Sign the transaction
            const signedTx = yield this.signTransaction(tx);
            // Broadcast the transaction if specified
            if (this.broadcast) {
                const txResponse = yield this.broadcastTransaction(signedTx);
...
function loadEnv() {
    const envPath = require$$1.resolve(process.cwd(), '.env'); // Points to the importing project's directory
...
class TransactionManager {
        ...
        for (const [chainName, chainConfig] of Object.entries(config.chains)) {
            if (chainConfig.privateKey === undefined) {
                ...
                if (!process.env[envVariableName]) {
                    throw new Error(`No private key found for chain "${chainName}, ` +
     ...
     * Broadcasts a signed transaction to the network.
     */
    broadcastTransaction(signedTx, chain) {
        return __awaiter(this, void 0, void 0, function* () {
            let chainManager = this.getChainManager(chain);
...
export { TransactionManager, test };
